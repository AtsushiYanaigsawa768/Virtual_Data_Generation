        ...
        for csv_file in csv_files:
            ...
            if len(df) > 1:
                ...
                if idx_candidates:
                    ...
                    idx_to_drop = random.sample(idx_candidates, min(100, len(idx_candidates)))
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(rootdir, 'data/test1')
    ...
    methods = ["high_performance", "precision", "fft"]
